...
\subsection{Operational Semantics: Call by value}

\[
\inferrule*[right=S-App1]
{ e_1 \longrightarrow e_1'  }
{ e_1 e_2 \longrightarrow e_1' e_2}
\]

\[
\inferrule*[right=S-App2]
...
{\overbar{x:\tau} \notin ftv(\Gamma) \\ \checktype e :\rho \\ pr(\sigma) = \forallvars{\hl{$x:\tau$}} . \rho} {\polycheck e : \sigma}
\]
