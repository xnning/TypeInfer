...
{
\checktype \sigma:\star \\
\polymorphic \sigma_1 \sqsubseteq \sigma \transto{g} \\
\cyancolorbox{f=\lambda x. g} \\
...
\[
\inferrule*[right=Inst-Check]
{\polymorphic \sigma \sqsubseteq \rho \transto {g} \\
\cyancolorbox{f=\lambda x. g}
}
...
{\Sigma \polymorphic \sigma_1 \sqsubseteq \sigma_2 \transto{ f_1\ (\lambda(\overbar{a:\tau_1}). f_2\ x) }}
\]
...
\translate{ \forallvars{a:\tau}.\rho_1 }{\sigma_1}
}
{\Sigma \polymorphicstar \forallvars{a:\tau}.\rho_1 \sqsubseteq \rho_2 \\
\transto { (\lambda x.\ f)\ (x\ \overbar{\beta_1}) }}
\]
...
\transto {\lambda y:\sigma_5 . f_2\ (x\ (f_1\ y))}
}
\]
...
{\Sigma \polymorphicstar \tau_1\, \sigma_1 \sqsubseteq \tau_2\, \sigma_1 \transto {\castupe f[x \mapsto \castdowne x]}}
\]

\[
\inferrule*[right=LAM]
{
\Sigma \polymorphic \sigma_2 \sqsubseteq \sigma_4 \transto {f}}
{\Sigma \polymorphicstar \lambda x. \sigma_2 \sqsubseteq \lambda x. \sigma_4 \transto {f}}
\]
...
{
\Sigma \polymorphic  \sigma_1 \sqsubseteq \sigma_2 \transto {f}}
{\Sigma \polymorphicstar  (\castdowne \sigma_1) \sqsubseteq  (\castdowne \sigma_2) \transto{\castupe f[x \mapsto \castdowne x]}}
\]
