...
$\Gamma, \Theta, \Delta  = \cdot~|~\Gamma, x~|~\Gamma, x:\sigma~|~\Gamma, \widehat{\alpha}~|~\Gamma, \widehat{\alpha}=\sigma~|~\Gamma, \widehat{\alpha}:\sigma~|~\Gamma, \widehat{\alpha}:\sigma = \sigma_2~|$
...
{\Gamma , \blacktriangleright, \overbar{\widehat \alpha : \tau} \polymorphicstar \rho_1[\overbar{\tpmapsto \tau x {\widehat \alpha}}] \sqsubseteq \rho_2 \dashv \Theta, \blacktriangleright, \Delta}
