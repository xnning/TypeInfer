...
\begin{algorithmic}[1]
\algloopdefx{Let}[1]{\textbf{Let} #1 \textbf{In}}
\Function{dsk\_star(S, T, U)}{}
    \If{$\alpha$-equal S T}
        \Return []
    \ElsIf{$S = \forall a:\tau_1. S_2$}
        \State $S' = instantiate\ S$
        \State dsk\_star($S', T, U$)
    \ElsIf{$S =$ TVar $X_1$ of $K_1$ and $T =$ TVar $X_2$ of $K_2$}
        \State $sub$ = dsk($K_1, K_2, U$)
        $[\tpmapsto {K_2} S T \ of\ K_2] \circ sub$
    \ElsIf{$S = \Pi x:S_1. S_2$ and $T = \Pi x: T_1. T_2$}
        \State $sub$ = dsk($S_1, T_1, U$)
        \State dsk\_star($S_2[sub], T_2[sub], U \cup \{x\}) \circ sub $
        \State $sub$ = dsk($K_2, K_1, U$)
        \State \Return $[\tpmapsto {K_1} X T \ of\ K_1] \circ sub$
    %TODO: occur check
    %TODO: type match
    \ElsIf{$S = \Pi x:S_1. S_2$ and $T =$ TVar $X_2$ of $K_2$}
        \State newTVar a b
        \State $sub1$ = $[\tpmapsto {} T {\Pi x:a. b} ]$
        \State $sub2$ = dsk\_star($a, S_1, U$)
        \State $sub3$ = dsk\_star($S_2, b, U$)
        \State \Return $ [\tpmapsto {} T {\Pi x:a. b} ] \circ sub3 \circ sub2 \circ sub1$
    \ElsIf{$S =$ TVar $X_1$ of $K_1$ and $T = \Pi x:S_1. S_2$}
        \State newTVar a b
        \State $sub1$ = $[\tpmapsto {} S {\Pi x:a. b} ]$
        \State $sub2$ = dsk\_star($S_1, a, U$)
        \State $sub3$ = dsk\_star($b, S_2, U$)
        \State \Return $ [\tpmapsto {} S {\Pi x:a. b} ] \circ sub3 \circ sub2 \circ sub1$
    \ElsIf{$S = cast^\uparrow S_1$ and $T = cast^\uparrow T_1$}
        \State dsk($S_1, T_1, U$)
    \ElsIf{$S = cast^\uparrow S_1$ and $T =$ TVar $X_2$ of $K_2$}
        \State newTVar a
        \State $sub1$ = $[\tpmapsto {} T {cast^\uparrow a} ]$
        \State $sub2$ = dsk\_star($S_1, a, U$)
        \State \Return $ [\tpmapsto {} T {\Pi x:a. b} ] \circ sub2 \circ sub1$
    \ElsIf{$S =$ TVar $X_1$ of $K_1$ and $T = cast^\uparrow S_2$ }
        \State newTVar a
        \State $sub1$ = $[\tpmapsto {} S {cast^\uparrow a} ]$
        \State $sub2$ = dsk\_star($a, S_2, U$)
        \State \Return $ [\tpmapsto {} T {\Pi x:a. b} ] \circ sub2 \circ sub1$
    \ElsIf{$S = cast^\downarrow S_1$ and $T = cast^\downarrow T_1$}
        \State dsk($S_1, T_1, U$)
    \ElsIf{$S = cast^\downarrow S_1$ and $T =$ TVar $X_2$ of $K_2$}
        \State newTVar a
        \State $sub1$ = $[\tpmapsto {} T {cast^\downarrow a} ]$
        \State $sub2$ = dsk\_star($S_1, a, U$)
        \State \Return $ [\tpmapsto {} T {\Pi x:a. b} ] \circ sub2 \circ sub1$
    \ElsIf{$S =$ TVar $X_1$ of $K_1$ and $T = cast^\downarrow S_2$ }
        \State newTVar a
    ...
    \ElsIf{$S =$ App $S_1$ $S_2$ and $T =$ TVar $X_2$ of $K_2$}
        \State newTVar a b
    ...
    \ElsIf{$S =$ TVar $X_1$ of $K_1$ and $T =$ App $T_1$ $T_2$}
        \State newTVar a b
    ...
    \ElsIf{$S =\lambda x:S_1. S_2$  and $T =$ TVar $X_2$ of $K_2$}
        \State newTVar a b
    ...
    \ElsIf{$S =$ TVar $X_1$ of $K_1$ and $T =\lambda x:T_1. T_2$}
        \State newTVar a b
