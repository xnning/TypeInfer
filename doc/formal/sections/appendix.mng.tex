...
\instinfercheck \sigma_2 [\tpmapsto {\sigma_1} x {e_2}] \sqsubseteq \rho}
...
\inferrule*[right=Let]
{\polyinfer e_1 : \sigma \\
\infercheck e_2[\tpmapsto {\sigma} x {e_1}]: \rho}
...
{\infertype e :\rho \\ \overbar{x:\tau}=ftv(\rho)-ftv(\Gamma) \\
\checktype (\forallvars{x:\tau}. \rho):\star } {\polyinfer e :(\forallvars{x:\tau}. \rho)}
\]

\[
\inferrule*[right=Gen-Check]
{
pr(\sigma) = \forallvars{x:\tau}. \rho \\
\overbar{x:\tau} \notin ftv(\Gamma) \\
\checktype e :\rho
} {\polycheck e : \sigma}
\]
