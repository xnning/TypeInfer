...
\Else
    ...
    \Let {$T = pr\ T'$}
        ...
        \ElsIf{$S =$ TVar $X$ of $K_1$ and $T$ of $K_2$ and $X \notin FV(T)$ and $T\in \tau$}
            \State $C''$ = $\polymorphic K_2 \sqsubseteq K_1$
            \State unify($[\tpmapsto {K_1} X T \ of\ K_1](C \cup C'')) \circ [\tpmapsto {K_1} X T]$
        \ElsIf{$T =$ TVar $X$ of $K_1$ and $S$ of $K_2$ and $X \notin FV(S)$ and $S\in \tau$}
            \State $C''$ = $\polymorphic K_2 \sqsubseteq K_1$
            \State unify($[\tpmapsto {K_1} X S \ of\ K_1](C \cup C'')) \circ [\tpmapsto {K_1} X S]$
