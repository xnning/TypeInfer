...
{
\checktype \sigma:\star \\
\translated{\sigma} \polymorphic \sigma_1 \sqsubseteq \sigma \transto{f} \\
...
\[
\inferrule*[right=Inst-Check]
{\translated{\rho}\polymorphic \sigma \sqsubseteq \rho \transto {f} \\
...
\sigma \polymorphicstar \sigma_1 \sqsubseteq \rho \transto{f_2}
}
{ \sigma \polymorphic \sigma_1 \sqsubseteq \sigma_2 \transto{f_1\ (\lambda(\overbar{a:\translated{\tau}}). f_2) }}
\]
...
\inferrule*[right=Spec]
{\overbar{b: \tau} \\
\sigma \polymorphicstar \rho_1[\overbar{\tpmapsto \tau a b}] \sqsubseteq \rho_2 \transto{f} \\
...
\[
\inferrule*[right=Fun]
{\translated{\sigma_1}\polymorphic  \sigma_3 \sqsubseteq \sigma_1 \transto{f_1} \\
\cyancolorbox{ g_1 = \lambda x:\translated{\sigma_3}. f_1 } \\
\translated{\rho_4}\polymorphicstar  \sigma_2[x \mapsto g_1\ y] \sqsubseteq \rho_4 \transto{f_2} \\
...
\transto {\castupe [\sigma]\ f[x \mapsto \castdowne x]}}
\]
