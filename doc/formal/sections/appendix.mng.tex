...
\framebox{$\polymorphicstar \sigma_1 \sqsubseteq \rho$}

\[
\hl{$
\inferrule*[right=Alpha-Equal]
{  \alpha-equal(\sigma_1, \sigma_2)  }
{  \polymorphicstar \sigma_1 \sqsubseteq \sigma_2 }
$}
\]
...
\Else
    ...
    \Let {$T = pr\ T'$}
        ...
        \ElsIf{$S =$ TVar $X$ of $K_1$ and $T$ of $K_2$ and $FV(T) \cap U = \emptyset$ and $X \notin FV(T)$ and $T\in \tau$}
            \State $C''$ = $\polymorphic K_2 \sqsubseteq K_1$
            \State unify($[\tpmapsto {K_1} X T \ of\ K_1](C \cup C''), U) \circ [\tpmapsto {K_1} X T]$
        \ElsIf{$T =$ TVar $X$ of $K_1$ and $S$ of $K_2$ and $FV(S) \cap U = \emptyset$ and $X \notin FV(S)$ and $S\in \tau$}
            \State $C''$ = $\polymorphic K_2 \sqsubseteq K_1$
            \State unify($[\tpmapsto {K_1} X S \ of\ K_1](C \cup C''), U) \circ [\tpmapsto {K_1} X S]$
