...
{\Gamma[\widehat \alpha] \dsk \widehat \alpha \sqsubseteq (\Pi x:\sigma. \rho):{\sigma_\rho} \dashv \Theta}
\]
...
{\Gamma[\widehat \alpha]\dsk \widehat \alpha \sqsubseteq (\tau_1\, \sigma_1):{\sigma_\rho} \dashv \Theta}
\]
...
{\Gamma[\widehat \alpha] \dsk \widehat \alpha \sqsubseteq (\lambda x. \sigma_2):{\sigma_\rho} \dashv \Theta }
\]
...
{\Gamma[\widehat \alpha]\dsk \widehat \alpha \sqsubseteq (\lambda x:\sigma_1. \sigma_2):{\sigma_\rho} \dashv \Theta
}
\]
...
{\Gamma[\widehat \alpha] \dsk \widehat \alpha \sqsubseteq (\sigma_1:\sigma_2):{\sigma_\rho} \dashv \Theta}
\]
...
{\Gamma[\widehat \alpha] \dsk  \widehat \alpha \sqsubseteq  (\castupe \sigma_1):{\sigma_\rho} \dashv \Theta}
\]
...
{\Gamma[\widehat \alpha] \dsk  \widehat \alpha \sqsubseteq  (\castdowne \sigma_2):{\sigma_\rho} \dashv \Theta}
\]
...
{\Gamma[\widehat \alpha] \dsk \widehat \alpha  \sqsubseteq  (let\ x = \sigma_1\ in\ \sigma_2):{\sigma_\rho} \dashv \Theta }
\]
...
{\Gamma[\alpha:\tau_\alpha] \dsk \sigma_\rho \sqsubseteq \tau_\alpha \dashv \Theta_1[\alpha:\tau_\alpha\{=\tau_1\}] \\
