...
\newcommand*{\ALamAnn}{\inferrule{
         ...
         \\ \tctx, x : \sigma_1 \byinf e \infto \sigma_2
            ...
            \tctx \byinf \blam x {\sigma_1} e \infto \bpi x {\sigma_1} {\sigma_2}
            }\rname{A-LamAnn}}
...
\newcommand*{\AApp}{\inferrule{
         ...
         \\ \tctx \byinf \applye \tctx {\sigma_1} \app e_2 \infto \sigma_2
            }{
            \tctx \byinf e_1 ~ e_2 \infto \sigma_2
            }\rname{A-App}}
...
\newcommand*{\UApp}{\inferrule{
            \tctx \byeuni \sigma_1 \uni \sigma_3 \toctx_1
         \\ \ctxl_1 \byeuni \applye {\ctxl_1} {\sigma_2} \uni \applye {\ctxl_1} {\sigma_4} \toctx
            }{
            \tctx \bybuni \sigma_1 ~ \sigma_2 \uni \sigma_3 ~ \sigma_4 \toctx
            }\rname{U-App}}
...
\newcommand*{\ULamAnn}{\inferrule{
         ...
         \\ \ctxl_1, x:\sigma_1 \byeuni \applye {\ctxl_1} {e_1} \uni \applye {\ctxl_1} {e_2} \toctx, x:\sigma_1
            ...
            \tctx \byeuni \blam x {\sigma_1} {e_1} \uni \blam x {\sigma_2} {e_2}
            }\rname{U-LamAnn}}
...
\newcommand*{\UPi}{\inferrule{
         ...
         \\ \ctxl_1, x:\sigma_1 \bysuni \applye {\ctxl_1} {\sigma_2} \uni
            ...
            \tctx \bybuni \bpi x {\sigma_1} {\sigma_2} \uni \bpi x {\sigma_3} {\sigma_4}
            }\rname{U-Pi}}
...
\newcommand*{\IApp}{\inferrule{
         ...
         \\ \ctxl_1 \bysa \tau_2 \sa \tau_4 \toctx
            }{
            \tctx \bysa \tau_1 ~ \tau_2 \sa \tau_3 ~ \tau_4 \toctx
            }\rname{I-App}}

\newcommand*{\ILamAnn}{\inferrule{
            \tctx \bysa \tau_1 \sa \tau_3 \toctx_1
         \\ \ctxl_1, x: \tau_1 \bysa \tau_2 \sa \tau_4 \toctx
            }{
            \tctx \bysa \blam x {\tau_1} {\tau_2} \sa \blam x {\tau_3} {\tau_4} \toctx
            }\rname{I-LamAnn}}
...
\newcommand*{\IAllPlus}{\inferrule{
            \tctx[\genB, \genA] \bypsa \sigma \subst x {\genB} \sa \tau \toctx
            }{
            \tctx[\genA] \bypsa \forall x. \sigma \sa \tau \toctx
            }\rname{I-All-Plus}}

\newcommand*{\IAllMinus}{\inferrule{
            x \notin FV(\sigma)
         \\ \tctx, x: \star \bymsa \sigma \sa \tau \toctx, x:\star
            }{
            \tctx \bymsa \forall x. \sigma \sa \tau \toctx
            }\rname{I-All-Minus}}

\newcommand*{\IPiPoly}{\inferrule{
            \tctx \bysa^{-s} \sigma_1 \sa \tau_1 \toctx_1
         \\ \ctxl_1, x:\tau_1 \bybsa {\sigma_2} \sa \tau_2 \toctx, x:\tau_1
            }{
            \tctx \bybsa \bpi x {\sigma_1} {\sigma_2} \sa \bpi x {\tau_1}
            {\tau_2} \toctx
            }\rname{I-Pi-Poly}}
