...
\bruno{unification and type sanitization?} algorithms.
...
\cctx \sigma$. Similarly, we can also apply a complete context to a
context that\bruno{please rephrase. I cannot quite understand the sentence}
