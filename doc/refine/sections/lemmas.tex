...
\newcommand*{\PolymorphicTypeSanitizationCompletenessTwoName}
{Polymorphic Type Sanitization Completeness}
\newcommand*{\PolymorphicTypeSanitizationCompletenessTwoBody}{
  Given $\tctx \exto \cctx $,
...
\newcommand*{\AlgorithmicSubtypingExtensionName}
{Algorithmic Subtyping Extension}
\newcommand*{\AlgorithmicSubtypingExtensionBody}{
  If $\tctx \bysub A \tsub B \toctx$,
  then $\tctx \exto \ctxl$.
}