...
\item [Part 1] In Part 1, we regard all $\delta = e$.
  ...
  \item Case \[\UApp\]
    \begin{longtable}[l]{lll}
      ...
      \applye {\ctxl_1} {\applye {\ctxl_1} {\sigma_1'''}} $
      & By Lemma~\ref{lemma:\ContextApplicationPreservesTypingName} \\
      & $\ctxl_1 \byinf \applye {\ctxl_1} {e_4} \infto
      \applye {\ctxl_1} {\applye {\ctxl_1} {\sigma_2'''}} $
      & By Lemma~\ref{lemma:\ContextApplicationPreservesTypingName} \\
      & $\ctxl_1 \exto \ctxl$
      & By induction hypothesis \\
      & $\tctx \exto \ctxl$
  ...
  \item Case \[\ULamAnn\]
    \begin{longtable}[l]{lll}
      ...
      \applye {\ctxl_1, x: \sigma_1} {\applye {\ctxl_1, x:\sigma_1} {\sigma_1''}} $
      & By Lemma~\ref{lemma:\ContextApplicationPreservesTypingName} \\
...
\begin{itemize}
  ...
  \item Case \[\UApp\]
    \begin{longtable}[l]{lll}
      ...
      & $\ctxl_1 \byinf e_2 \infto \applye {\ctxl_1} {\sigma_1'''}$
      & By Lemma~\ref{lemma:\ExtensionWeakningName} \\
      & $\ctxl_1 \byinf \applye {\ctxl_1} {e_2} \infto \applye {\ctxl_1}
  ...
  \item Case \[\ULamAnn\]
    \begin{longtable}[l]{lll}
      ...
      \infto \applye {\ctxl_1, x: \sigma_1} {\applye {\ctxl_1, x: \sigma_1} {\sigma_1''} }$
      & By Lemma~\ref{lemma:\ContextApplicationPreservesTypingName} \\
      & $\ctxl_1, x: \sigma_1 \byinf {\applye {\ctxl_1, x: \sigma_1} {e_1}}
