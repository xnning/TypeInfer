...
\begin{itemize}
  ...
  \item Case \[\IApp\]
    \begin{longtable}[l]{lll}
      ...
      & $\tctx \byinf \tau_1 ~ \tau_2 \infto \sigma $ & Given \\
      & $\tctx \byinf \tau_2 \infto \sigma' $ & By inversion \\
      & $\ctxl_1 \byinf \tau_2 \infto \applye {\ctxl_1} {\sigma'} $
  ...
  \item Case \[\ILamAnn\]
    \begin{longtable}[l]{lll}
      & $\tctx \exto \ctxl_1$ & By induction hypothesis \\
      & $\tctx \byinf \blam x {\tau_1} {\tau_2} \infto \sigma $ & Given \\
      & $\tctx, {x : \tau_1} \byinf {\tau_2} \infto \sigma' $ & By inversion \\
      & $\tctx, {x : \tau_1} \exto \ctxl_1, x : \tau_1 $ & By \rul{CE-Var} \\
      & $\ctxl_1, {x : \tau_1} \byinf {\tau_2} \infto \applye {\ctxl_1, x:
...
\begin{itemize}
  ...
  \item Case \[\IApp\]
    \begin{longtable}[l]{lll}
      & $\applye {\ctxl_1} {\tau_1} = \applye {\ctxl_1} {\tau_3}$
      & By induction hypothesis \\
      & $\tctx \byinf \tau_1 ~ \tau_2 \infto \sigma $ & Given \\
      & $\tctx \byinf \tau_1 \infto \sigma' $ & By inversion \\
      & $\tctx \byinf \tau_2 \infto \sigma'' $ & By inversion \\
      & $\tctx \exto \ctxl_1$
      ...
      & $\ctxl_1 \exto \ctxl$
      & By Lemma~\ref{lemma:\TypeSanitizationExtensionName} \\
      & $\applye {\ctxl} {\tau_2} = \applye {\ctxl} {\tau_4}$
      & By induction hypothesis \\
      & $\applye \ctxl {\tau_3} $& \\
      & $= \applye \ctxl {\applye {\ctxl_1} {\tau_3}} $
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $= \applye \ctxl {\applye {\ctxl_1} {\tau_1}} $
      & By above equalities \\
      & $= \applye \ctxl {\tau_1} $
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
    \end{longtable}
  \item Case \[\ILamAnn\]
    \begin{longtable}[l]{lll}
      & $\tctx \byinf \blam x {\tau_1} {\tau_2} \infto \sigma$
      & Given \\
      ...
      & $\applye {\ctxl} {\tau_2} = \applye {\ctxl} {\tau_4}$
      & By induction hypothesis \\
      & $\applye {\ctxl} {\tau_1} = \applye {\ctxl} {\tau_3}$
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
    \end{longtable}
  \item Case \[\IPi\]
    Similar as Case \rul{I-LamAnn}.
...
\begin{itemize}
  ...
  \item Case \[\IApp\]
    \begin{longtable}[l]{lll}
      & $\tctx \byinf \tau_1 \infto \bpi x {\sigma_1} {\sigma_2}$ & By inversion \\
      & $\tctx \byinf \tau_2 \infto \sigma_1$ & By inversion \\
      & $\sigma = \sigma_2 \subst x {\applye \tctx {\tau_2}}$ & By inversion \\
      & $\ctxl_1 \byinf \tau_3 \infto \applye {\ctxl_1} {\bpi x {\sigma_1} {\sigma_2}}$
      & By induction hypothesis \\
      & $\tctx \exto \ctxl_1$
      & By Lemma~\ref{lemma:\TypeSanitizationExtensionName} \\
      & $\ctxl_1 \byinf \tau_2 \infto \applye {\ctxl_1} {\sigma_1}$
      & By Lemma~\ref{lemma:\ExtensionWeakningName} \\
      & $\ctxl \byinf \tau_4 \infto \applye {\ctxl} {\applye {\ctxl_1} {\sigma_1}}$
      & By induction hypothesis \\
      & $\ctxl_1 \exto \ctxl$
      & By Lemma~\ref{lemma:\TypeSanitizationExtensionName} \\
      & $\ctxl \byinf \tau_4 \infto \applye {\ctxl} {\sigma_1}$
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $\ctxl \byinf \tau_3 \infto \applye \ctxl {\applye {\ctxl_1} {\bpi x {\sigma_1} {\sigma_2}}}$
      & By Lemma~\ref{lemma:\ExtensionWeakningName} \\
      & $\ctxl \byinf \tau_3 \infto \applye \ctxl {\bpi x {\sigma_1} {\sigma_2}}$
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $\ctxl \byinf \tau_3 ~ \tau_4 \infto (\applye \ctxl {\sigma_2}) \subst x
      {\applye \ctxl {\tau_4}} $
      & By \rul{A-App} \\
      & $\applye \ctxl {\tau_2} = \applye \ctxl {\tau_4} $
      ...
      & $\tctx \exto \ctxl$
      & By Lemma~\ref{lemma:\ContextExtensionTransitivityName} \\
      & $\applye \ctxl {\tau_2} = \applye \ctxl {\applye {\tctx} {\tau_2}}$
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $\ctxl \byinf \tau_3 ~ \tau_4 \infto (\applye \ctxl {\sigma_2}) \subst x
      {\applye \ctxl {\applye \tctx {\tau_2}}} $
      & By substituting above equality \\
      & $\ctxl \byinf \tau_3 ~ \tau_4 \infto \applye \ctxl
      {\sigma_2 \subst x {\applye \tctx {\tau_2}}} $
      & By property of substitution
    \end{longtable}
  \item Case \[\ILamAnn\]
    \begin{longtable}[l]{lll}
      & $\tctx \byinf \tau_1 \infto \star $ & By inversion \\
      & $\tctx, x: \tau_1 \byinf \tau_2 \infto \sigma_1$ & By inversion \\
      & $\sigma = \bpi x {\applye \tctx {\tau_1}} {\sigma_1}$ & By inversion \\
      & $\ctxl_1 \byinf \tau_3 \infto \star$
      & By induction hypothesis \\
      & $\tctx \exto \ctxl_1$
      & By Lemma~\ref{lemma:\TypeSanitizationExtensionName} \\
      & $\tctx, x: \tau_1 \exto \ctxl_1, x:\tau_1$
      & By \rul{CE-Var} \\
      & $\ctxl_1, x: \tau_1 \byinf \tau_2 \infto \applye {\ctxl_1, x: \tau_1} {\sigma_1}$
      & By Lemma~\ref{lemma:\ExtensionWeakningName} \\
      & $\ctxl_1, x: \tau_1 \byinf \tau_2 \infto \applye {\ctxl_1} {\sigma_1}$
      & By definition of context substitution \\
      & $\ctxl, x:\tau_1 \byinf \tau_4 \infto \applye {\ctxl, x :\tau_1} {\applye {\ctxl_1} {\sigma_1}}$
      & By induction hypothesis \\
      & $\ctxl, x:\tau_1 \byinf \tau_4 \infto \applye {\ctxl} {\applye {\ctxl_1} {\sigma_1}}$
      & By definition of context substitution \\
      & $\ctxl_1, x:\tau_1 \exto \ctxl, x : \tau_1$
      & By Lemma~\ref{lemma:\TypeSanitizationExtensionName} \\
      & $\ctxl_1 \exto \ctxl$
      & By inversion \\
      & $\ctxl, x: \tau_1 \byinf \tau_4 \infto \applye {\ctxl} {\sigma_1}$
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $\ctxl \byinf \tau_3 \infto \star$
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $\tctx \exto \ctxl$
      & By Lemma~\ref{lemma:\ContextExtensionTransitivityName} \\
      ...
      & $\ctxl, x: \applye \ctxl {\tau_1} \byinf \tau_4 \infto \applye {\ctxl} {\sigma_1}$
      & By Lemma~\ref{lemma:\ContextApplicationInContextName} \\
      & $\applye {\ctxl_1} {\tau_1} = \applye {\ctxl_1} {\tau_3} $
      & By Lemma~\ref{lemma:\TypeSanitizationEquivalenceName} \\
      & $\applye {\ctxl} {\tau_1} = \applye {\ctxl} {\tau_3} $
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $\ctxl, x: \applye \ctxl {\tau_3} \byinf \tau_4 \infto \applye {\ctxl} {\sigma_1}$
      & By substituting above equality \\
      & $\ctxl, x: {\tau_3} \byinf \tau_4 \infto \applye {\ctxl} {\sigma_1}$
      & By Lemma~\ref{lemma:\ReverseContextApplicationInContextName}\\
      & $\ctxl \byinf \blam x {\tau_3} {\tau_4} \infto \bpi x {\applye \ctxl
        {\tau_3}} {\applye \ctxl {\sigma_1}} $
      & By \rul{A-LamAnn} \\
      & $\bpi x {\applye \ctxl {\tau_3}} {\applye \ctxl {\sigma_1}}$ & \\
      & $= \bpi x {\applye \ctxl {\applye {\tctx} {\tau_3}}} {\applye \ctxl
        {\sigma_1}}$
      & By Lemma~\ref{lemma:\SubstitutionExtensionInvarianceName} \\
      & $= \applye \ctxl {\bpi x {\applye {\tctx} {\tau_3}} {\sigma_1}}$
      & By property of substitution
    \end{longtable}
  \item Case \[\IPi\]
    Similar as Case \rul{I-LamAnn}.
