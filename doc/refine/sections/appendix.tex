...
\begin{description}
  \item [Part 1]
    We have $\applye \cctx \tctx \bysub \applye \cctx A \dsub \applye \cctx
    \genA $. We now case analyze the shape of $A$.
    \begin{itemize}
    \item Case $A = \genB$.
      \begin{longtable}[l]{lll}
        & $\genA \notin FV(A)$
        ...
        & $\genA \neq \genB$
        & Follows directly \\
        & $\applye \cctx \genA = \tau_1$, $\applye \cctx \genB = \tau_2$
        & Assume \\
        & $\applye \cctx \tctx \bysub \tau_1 \dsub \tau_2 $
        & Given \\
        & $\tau_1 = \tau_2$
      ...
      two cases.
      \begin{itemize}
      \item SubCase $\tctx = \tctx_0, \genA, \tctx_1, \genB, \tctx_2 $.
        \begin{longtable}[l]{lll}
          & $\tctx_0, \genA, \tctx_1, \genB, \tctx_2 \bypsa \genB \sa \genA_1
          \toctxo_0, \genA_1, \genA, \tctx_1, \genB = \genA_1, \tctx_2
          $
          & By \rul{I-EVarAfterPoly} \\
          & $\tctx_0, \genA, \tctx_1, \genB, \tctx_2 \bysub \genB \tsub \genA
          \toctxo_0, \genA_1, \genA = \genA_1, \tctx_1, \genB = \genA_1, \tctx_2
          $
          & By \rul{$\tsub$InstR} \\
          & $\tctx_0, \genA, \tctx_1, \genB, \tctx_2 \exto \cctx $
          & Given \\
          & $\cctx = \cctx[\genA = \tau']$
          & By Lemma~\ref{lemma:dunfield:ExtensionOrder} \\
          & $\applye \cctx {\tau'} = \tau_1$
          & Known \\
          & $\tctx_0, \genA_1 = \tau_1, \genA, \tctx_1, \genB, \tctx_2 \exto
          \cctx[\genA_1 = \tau_1, \genA = \tau'] $
          & By Lemma~\ref{lemma:dunfield:ParallelAdmissibility} \\
          & $\tctx_0, \genA_1 = \tau_1, \genA = \genA_1, \tctx_1, \genB, \tctx_2 \exto
          \cctx[\genA_1 = \tau_1, \genA = \tau'] $
          & By Lemma~\ref{lemma:dunfield:ParallelExtensionSolution} \\
          & $\tctx_0, \genA_1 = \tau_1, \genA = \genA_1, \tctx_1, \genB = \genA_1, \tctx_2 \exto
          \cctx[\genA_1 = \tau_1, \genA = \tau'] $
          & By Lemma~\ref{lemma:dunfield:ParallelExtensionSolution} \\
          & $\tctx_0, \genA_1, \genA = \genA_1, \tctx_1, \genB = \genA_1,
          \tctx_2
          \exto \tctx_0, \genA_1 = \tau_1, \genA = \genA_1, \tctx_1, \genB =
          \genA_1, \tctx_2 $
          &  By Lemma~\ref{lemma:dunfield:SolutionAdmissibilityForExtension} \\
          & $\tctx_0, \genA_1, \genA = \genA_1, \tctx_1, \genB = \genA_1,
          \tctx_2
          ...
          \cctx[\genA_1 = \tau_1, \genA = \tau'] $
          & By Lemma~\ref{lemma:dunfield:Transitivity} \\
          & $\cctx' = \cctx[\genA_1 = \tau_1, \genA = \tau']$
          & Choose \\
          & $\cctx[\genA = \tau'] \exto \cctx[\genA_1 = \tau_1, \genA = \tau']$
          & By Lemma~\ref{lemma:dunfield:SolvedVariableAdditionForExtension}
        \end{longtable}
      \item SubCase $\tctx = \tctx_0, \genB, \tctx_1, \genA, \tctx_2 $.
        \begin{longtable}[l]{lll}
          & $\tctx_0, \genB, \tctx_1, \genA, \tctx_2 \bypsa \genB \sa \genB
          \toctxo_0, \genB, \tctx_1, \genA, \tctx_2
          $
          & By \rul{I-EVarBeforePoly} \\
          & $\tctx_0, \genB, \tctx_1, \genA, \tctx_2 \bysub \genB \tsub \genA
          \toctxo_0, \genB, \tctx_1, \genA = \genB, \tctx_2
          $
          & By \rul{$\tsub$InstR} \\
          & $\tctx_0, \genB, \tctx_1, \genA, \tctx_2 \exto \cctx $
          & Given \\
          & $\applye \cctx \genA = \applye \cctx \genB$
          & Known \\
          & $\tctx_0, \genB, \tctx_1, \genA = \genB, \tctx_2
          \exto \cctx $
          & By Lemma~\ref{lemma:dunfield:ParallelExtensionSolution} \\
          & $\cctx' = \cctx$
          & Choose
    ...
    \item Case $A = \varA$.
      \begin{longtable}[l]{lll}
        ...
        & By definition of context application \\
        & $\applye \cctx \tctx \bysub \varA \dsub \applye \cctx \genA$
        & Given \\
        & $\applye \cctx \genA = \varA$
        & By inversion (Since $\applye \cctx \genA$ cannot have polymorphic type)\\
        & $\cctx \wc$
        & Implicitly assume \\
        & $\varA$ is declared to the left of $\genA$ in $\cctx$
        & Follows directly \\
        & $\tctx \exto \cctx$
        & Given \\
        & $\varA$ is declared to the left of $\genA$ in $\tctx$
        & By Lemma~\ref{lemma:dunfield:ReverseDeclarationOrderPreservation} \\
        & $\tctx = \tctx_0, \varA, \tctx_1, \genA, \tctx_2 $
        & Assume \\
        & $\tctx_0, \varA, \tctx_1, \genA, \tctx_2 \bypsa \varA \sa \varA  \toctxo_0, \varA, \tctx_1, \genA, \tctx_2 $
        & By \rul{I-TVar} \\
        & $\tctx_0, \varA, \tctx_1, \genA, \tctx_2 \bysub \varA \tsub \genA
        \toctxo_0, \varA, \tctx_1, \genA = \varA, \tctx_2 $
        & By \rul{$\tsub$InstR} \\
        & $\cctx' = \cctx$
        & Choose \\
        & $\tctx_0, \varA, \tctx_1, \genA = \varA, \tctx_2 \exto \cctx $
        & By Lemma~\ref{lemma:dunfield:ParallelExtensionSolution}
      \end{longtable}
    \item Case $A = \Unit$.
      \begin{longtable}[l]{lll}
        ...
        & By definition of context application \\
        & $\applye \cctx \tctx \bysub \Unit \dsub \applye \cctx \genA$
        & Given \\
        & $\applye \cctx \genA = \Unit$
        & By inversion (Since $\applye \cctx \genA$ cannot have polymorphic type)\\
        & $\tctx = \tctx_0, \genA, \tctx_1 $
        & Assume \\
        & $\tctx_0, \genA, \tctx_1 \bypsa \Unit \sa \Unit  \toctxo_0, \genA, \tctx_1 $
        & By \rul{I-Unit} \\
        & $\tctx_0, \genA, \tctx_1 \bysub \Unit \tsub \genA
        \toctxo_0, \genA = \Unit, \tctx_1 $
        & By \rul{$\tsub$InstR} \\
        & $\cctx' = \cctx$
        & Choose \\
        & $\tctx_0, \genA , \tctx_1 \exto \cctx $
        & Given \\
        & $\tctx_0, \genA = \Unit, \tctx_1 \exto \cctx $
        & By Lemma~\ref{lemma:dunfield:ParallelExtensionSolution}
      \end{longtable}
    \item Case $A = A_1 \to A_2$
      \begin{longtable}[l]{lll}
        ...
        & By definition of context application \\
        & $\applye \cctx \tctx \bysub
        \applye \cctx {A_1} \to \applye \cctx {A_2} \dsub
        \applye \cctx \genA $
        & Given \\
        & $\applye \cctx \genA = \tau_1 \to \tau_2 $
        & By inversion (Since $\applye \cctx \genA$ cannot have polymorphic type)\\
        & $\applye \cctx \tctx \bysub \tau_1 \dsub \applye \cctx {A_1} $
        & Namely \\
        & $\applye \cctx \tctx \bysub \applye \cctx {A_2} \dsub \tau_2 $
        & Namely \\
        & $\tctx = \tctx_1, \genA, \tctx$
        & Assume \\
        & $\cctx = \cctx_{11}, \genA = \sigma', \cctx_{12} $
        & By Lemma~\ref{lemma:dunfield:ExtensionOrder} \\
        & $\tctx_1 \exto \cctx_{11}$
        & As above \\
        & $\cctx_1 = \cctx_{11}, \genA = \tau_1, \cctx_{12} $
        & Choose \\
      \end{longtable}
    \end{itemize}
\end{description}

\begin{lemma}[\PolymorphicTypeSanitizationCompletenessTwoName]
  \label{lemma:\PolymorphicTypeSanitizationCompletenessTwoName}
  \PolymorphicTypeSanitizationCompletenessTwoBody
\end{lemma}
...
\subsection{Properties of Algorithmic Subtyping}

\begin{lemma}[\AlgorithmicSubtypingExtensionName]
  \label{lemma:\AlgorithmicSubtypingExtensionName}
  \AlgorithmicSubtypingExtensionBody
\end{lemma}
