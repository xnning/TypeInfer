...
sanitization all enjoy the same philosophy: \textit{for an unsolved existential
  ...
  existential variable $\genB$ does not matter}.\bruno{You mean unsolved type
  variables here, right?}\bruno{Also I don't think this statement is correct. We
  discussed before that swapping unsolved variables is not always correct in the
  general case.} \ningning{I changed the statement now.}
