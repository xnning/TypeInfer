...
judgment ($\ist$). Due to the limitation of space, we put the complete
definition of the instantiation relationship in the appendix.
...
as we have seen in type sanitization in Section~\ref{subsec:type-sanitization}.
