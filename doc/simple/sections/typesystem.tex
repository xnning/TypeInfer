...
\begin{figure}[h]
    ...
    \headercapm{\tctx \bywf \sigma \toctx}{Well Form of type $\sigma$ under
      context $\tctx$ with output context $\ctxl$}

    \[\TWFEVar \quad \TWFPi \]
    \[\TWFPoly \quad \TWFOther \]

    \headercapm{\tctx\wc\ctxl}{Context $\tctx$ is well formed with output context $\ctxl$}
