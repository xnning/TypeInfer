...
For the sake of clarity, we represent other expressions by their explicit constructor head and components so all the cases could be combined into one rule \rul{I-Other}. Here gives some examples:
