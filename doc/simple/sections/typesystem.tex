...
\begin{figure}[h]
    \headercapm{\ctx \bywt \sigma}{Well Form of $\sigma$ under context $\ctx$}
...
Having the I-rules, back to rule \rul{U-EvarTy}. It contains \rul{InstLSolve} directly since we have $\tau_1 \cgto \tau_1$. And reader could check it also contains \rul{InstLArr} and \rul{InstLReach}.
