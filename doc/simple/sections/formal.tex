...
\newcommand*{\TAx}{\inferrule{\tctx \wc \ctxl }{\tpreinf \star:\star \toctx}\rname{T-Ax}}
\newcommand*{\TVar}{\inferrule{x:\tau \in \tctx \\ \tctx \wc \ctxl}{\tpreinf x:\tau \toctx
  }\rname{T-Var}}
\newcommand*{\TLetVar}{\inferrule{x:\sigma = \tau \in \tctx \\ \tctx \wc \ctxl_1 \\
    \ctxl_1 \byinst \sigma \lt \tau_2 \toctx}{\tpreinf x:\tau_2 \toctx
  }\rname{T-LetVar}}
...
\newcommand*{\TWFEVar}{\inferrule{\genA \in \tctx }{\tprewf \genA \toctxo}\rname{WF-EVar}}
\newcommand*{\TWFPi}{\inferrule{\tprewf \tau_1 \toctx_1\\ \ctxl_1, x:\tau_1
    \bywf \tau_2 \toctx,x:\tau_1,\ctxr }{\tprewf \bpi x {\tau_1} {\tau_2} \toctx}\rname{WF-Pi}}
\newcommand*{\TWFPoly}{\inferrule{\tprewf[,x:\star] \sigma \toctx,
    x:\star,\ctxr}{ \tprewf \forall x: \star. \sigma \toctx}\rname{WF-Poly}}
\newcommand*{\TWFOther}{\inferrule{ \tprechk \tau : \star \toctx}{ \tprewf \tau \toctx}\rname{WF-Other}}
...
\newcommand*{\TWCEmpty}{\inferrule{ }{\ctxinit \wc \ctxinit}\rname{WC-Empty}}
\newcommand*{\TWCVar}{\inferrule{\tctx \wc \ctxl \\ x \notin dom(\tctx)}{\tctx, x \wc \ctxl, x}\rname{WC-Var}}
\newcommand*{\TWCTypedVar}{\inferrule{\tctx \wc \ctxl_1 \\ x \notin dom(\tctx) \\
    \ctxl_1 \bywf \tau \toctx}{\tctx, x: \tau \wc \ctxl, x: \tau}\rname{WC-TypedVar}}
\newcommand*{\TWCLetVar}{\inferrule{\tctx \wc \ctxl_1 \\ x \notin dom(\tctx) \\
    \ctxl_1 \bywf \sigma \toctx_2 \\
    \sigma = \forall {\overbar {y:\star}}.\tau \\
    \ctxl_2 ,\overbar{y:\star} \bychk e:[\ctxl_2]\tau \toctx, \overbar{y:\star}, \ctxr}
{\tctx, x:\sigma = e \wc \ctxl, x:\sigma = e}\rname{WC-LetVar}}
\newcommand*{\TWCEVar}{\inferrule{\tctx \wc \ctxl\\ \genA \notin
    dom(\tctx)}{\tctx, \genA \wc \ctxl, \genA}\rname{WC-EVar}}
\newcommand*{\TWCSolvedEVar}{\inferrule{\tctx \wc \ctxl_1 \\ \genA \notin
    dom(\tctx) \\ \ctxl_1 \bywf \tau \toctx}{\tctx, \genA = \tau \wc \ctxl,
  \genA = \tau}\rname{WC-SolvedEVar}}
