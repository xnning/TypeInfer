...
\newcommand*{\DAPoly}{\inferrule{
    \dprechk \tau : \star \\
    \dprechk \sigma \subst \typA \tau ~ e_2: \sigma_2 \trto {t_2}
...
\newcommand*{\SPolyR}{\inferrule{\tpresub[, \typA] \sigma_1 \lt \sigma_2 \toctx }{\tpresub \sigma_1 \lt \forall \typA:\star. \sigma_2 \toctx}\rname{S-PolyR}}
...
\newcommand*{\SPi}{\inferrule{\tpresub \sigma_3 \lt \sigma_1 \toctx_1 \\ \ctxl_1, x:\sigma_1 \bysub \sigma_2 \lt \sigma_4 \toctx, x:\sigma_1,\ctxr}{\tpresub \bpi x {\sigma_1} {\sigma_2} \lt \bpi x {\sigma_3} {\sigma_4} \toctx}\rname{S-Pi}}
\newcommand*{\SEVarL}{\inferrule{\genA \notin FEV(\sigma) \\ \tctx \byrf^- \sigma \rfto \tau \toctx[\genA]}{\tpresub[{[\genA]}] \genA \lt \sigma \toctx[\genA = \tau]}\rname{S-EVarL}}
\newcommand*{\SEVarR}{\inferrule{\genA \notin FEV(\sigma) \\ \tctx \byrf^+ \sigma \rfto \tau \toctx[\genA]}{\tpresub[{[\genA]}] \sigma_1 \lt \genA \toctx[\genA = \tau]}\rname{S-EVarR}}
...
\newcommand*{\IOthersNew}{\inferrule{i \in [0..n) \\ \tctx_i^s \bycg e_i \cgto e_i' \toctxo_{i+1} } {\tctx_0^s \bycg D~\overbar {e_n} \cgto D~\overbar {e'_n} \toctxo_n }\rname{I-Other}}
...
\newcommand*{\ITau}{\inferrule{\tctx \bycg \tau_1 \cgto \tau_2 \toctx }{\tctx \byrf^s \tau_1 \rfto \tau_2 \toctx}\rname{I-Mono}}
% ------------------------------------------------------------------------
% WELL FORM
% ------------------------------------------------------------------------
