...
\newcommand*{\DVar}{\inferrule{x:\tau \in \ctx}{\preinf x:\tau
  \trto x}\rname{D-Var}}
\newcommand*{\DEVar}{\inferrule{ }{\preinf \genA:\star}\rname{D-EVar}}
...
\newcommand*{\DInstantiation}{\inferrule{\sigma = \forall{\overbar{x:\star}}. \tau}{\preinst \sigma \lt \tau[\overbar{x} \mapsto \overbar{\genA}]} \rname{D-Inst}}

\newcommand*{\DGeneralization}{\inferrule{\overbar{\genA} = FV(\tau) - FV(\ctx)}{\pregen \tau \lt \forall \overbar{x:\star}. \tau_2[\overbar{\genA} \mapsto \overbar{x}]} \rname{D-Gen}}
