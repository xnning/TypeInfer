...
\newcommand*{\TAnn}{\inferrule{\prechk \tau:\star \toctx_1 \trto{t} \\
  ...
  \trto t}\rname{T-Ann}}
\newcommand*{\TLamInf}{\inferrule{\prechk[,\genA,x:\genA,\genB]
    e:\genB \toctx \trto t}{\preinf \erlam x e : \bpi x \genA
...
\newcommand*{\TLamAnn}{\inferrule{\prechk \tau_1 : \star \toctx_1
    \trto {t_1} \\
    \ctxl_1,x:\tau_1, \genB \bychk
    e:\genB \toctx \trto {t_2}}{\preinf \blam x {\tau_1} e : \bpi x {\tau_1}
    \genB \toctx \trto {\blam x {t_1} t_2}}\rname{T-LamAnn}}
