...
\newcommand*{\Instantiation}{\inferrule{\sigma = \forall{\overbar{x:\star}}. \tau}{\preinst \sigma \lt \tau[\overbar{x} \mapsto \overbar{\genA}] \toctxo, \overbar{\genA}} \rname{Inst}}

\newcommand*{\Generalization}{\inferrule{\tau_2 = [\ctx]\tau \\ \overbar{\genA} = FEV(\tau_2) - FEV(\ctx)}{\pregen \tau \lt \forall \overbar{x:\star}. \tau_2[\overbar{\genA} \mapsto \overbar{x}]} \rname{Gen}}
...
\newcommand*{\WFPoly}{\inferrule{ \prewf[,x:\star] \sigma}{ \prewf \forall x: \star. \sigma}\rname{WF-Poly}}
\newcommand*{\WFOther}{\inferrule{ \prechk \tau : \star}{ \prewf \tau}\rname{WF-Other}}

\newcommand*{\TWFEVar}{\inferrule{\genA \in \ctx }{\prewf \genA}\rname{WF-EVar}}
\newcommand*{\TWFPi}{\inferrule{\prewf \tau_1 \\ \prewf \tau_2 }{\prewf \bpi x {\tau_1} {\tau_2}}\rname{WF-Pi}}
\newcommand*{\TWFPoly}{\WFPoly}
\newcommand*{\TWFOther}{\inferrule{ \prechk \tau : \star \toctx}{ \prewf \tau}\rname{WF-Other}}
