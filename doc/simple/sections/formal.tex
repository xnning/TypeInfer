...
\newcommand*{\TLamInf}{\inferrule{\preinf[,\genA,x:\genA]
    ...
    [\ctxr]\tau_2) \toctx, UV(\ctxr) \trto {\blam x \genA t}}\rname{T-Lam$\Inf$}}
\newcommand*{\TLamChk}{\inferrule{\prechk[,x:\tau_1]
    e:\tau_2 \toctx,x:\tau_1,\ctxr \trto {t_2} \\
    %\prechk {\bpi x {t_1} \tau_2 : \star \toctx_1 \trto {\bpi x {t_1} t_3}}
...
\newcommand*{\TLamAnn}{\inferrule{\prechk \tau_1 : \star \toctx_1
    ...
    [\ctxr]\tau_2) \toctx, UV(\ctxr) \trto {\blam x {t_1} t_2}}\rname{T-LamAnn}}
\newcommand*{\TApp}{\inferrule{
    \preinf e_1 : \tau_1 \toctx_1 \trto {t_1} \\
    \ctxl_1 \byapp [\ctxl_1]\tau_1~e_2 : \tau_2 \toctx \trto {t_2} \\
}{\preinf e_1~e_2:\tau_2 \toctx \trto {t_1~t_2}}\rname{T-App}}
...
\kw{in} e_2 : [x:\sigma=e_1, \ctxr]\tau_2 \toctx, UV(\ctxr) \\ \trto {t_2[x \mapsto t_1]}}\rname{T-Let}}
...
\newcommand*{\DVar}{\inferrule{x:\tau \in \ctx}{\preinf x:\tau
  \trto x}\rname{D-Var}}
\newcommand*{\DEVar}{\inferrule{ }{\preinf \varA:\star}\rname{D-EVar}}
\newcommand*{\DLetVar}{\inferrule{x:\sigma = \tau \in \ctx \\ \preinst \sigma \lt \tau_2}{\preinf x:\tau_2
  \trto x}\rname{D-LetVar}}
...
\newcommand*{\DAnn}{\inferrule{\prechk \tau:\star \\
  ...
  \trto t}\rname{D-Ann}}
\newcommand*{\DLamInf}{\inferrule{ \prechk \tau_1 : \star \\ \preinf[,x:\tau_1]
    e:\tau_2 \trto t}{\preinf \erlam x e : (\bpi x {\tau_1} {\tau_2})
    \trto {\blam x \genA t}}\rname{D-Lam$\Inf$}}
...
\newcommand*{\DLet}{\inferrule{\preinf e_1 : \tau_1 \trto {t_1} \\
\pregen {\tau_1} \lt \sigma \\
\ctx, x:\sigma = e_1 \byall e_2 : \tau_2 \trto {t_2}}{\preall \kw{let} x=e_1
\kw{in} e_2 : \tau_2 \trto {\kw{let} x = t_1 \kw{in} t_2}}\rname{D-Let}}
...
\newcommand*{\DConv}{\inferrule{\preinf e_1 : \tau_1 \\ [\ctx]\tau_1 = [\ctx]\tau_2}{\preinf e_1 : \tau_2}\rname{D-Conv}}

\newcommand*{\DInstantiation}{\inferrule{\prechk \overbar{\tau} : \star \\ \sigma = \forall{\overbar{x:\star}}. \tau}{\preinst \sigma \lt \tau[\overbar{x} \mapsto \overbar{\tau}]} \rname{D-Inst}}

\newcommand*{\DGeneralization}{\inferrule{\overbar{\varA} = FV(\tau) - FV(\ctx)}{\pregen \tau \lt \forall \overbar{x:\star}. \tau_2[\overbar{\varA} \mapsto \overbar{x}]} \rname{D-Gen}}
...
\newcommand*{\SApp}{\inferrule{ e_1 \redto e_2 }{e_1~e_2 \redto e_1'~e_2}\rname{S-App}}
