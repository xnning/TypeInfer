...
\newcommand*{\TEVar}{\inferrule{\genA \in \tctx \\ \tctx \wc}{\tpreinf \genA:\star \toctxo
  }\rname{T-EVar}}
...
\newcommand*{\UAnn}{\inferrule{\tpreuni \tau \lt \tau' \toctx_1 \\
    ...
    \toctx}\rname{U-Ann}}
\newcommand*{\UOthers}{\inferrule{i \in [0..n) \\ \tctx_i [,x] \byuni e_i \lt e_i' \toctxo_{i+1} [,x] } {\tctx_0 \byuni D~\overbar {e_n} \lt D~\overbar {e'_n} \toctxo_n }\rname{U-Other}}
...
\newcommand*{\IOthersNew}{\inferrule{i \in [0..n) \\ \tctx_i \bycg e_i \cgto e_i' \toctxo_{i+1} } {\tctx_0 \bycg D~\overbar {e_n} \cgto D~\overbar {e'_n} \toctxo_n }\rname{I-Other}}
