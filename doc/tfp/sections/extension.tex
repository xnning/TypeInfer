...
\paragraph{Types and Contexts.} The definition of types $\sigma$ is the same.
Monotype $\tau$ is a special kind of $\sigma$ that
contains no universal quantifiers. Therefore, only monotypes can be solutions of
