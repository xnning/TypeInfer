...
\newcommand*{\TLamAnnInf}{\inferrule{\tprechk \sigma_1 : \star \toctx_1\\
    \ctxl_1,x:\sigma_1 \byinf
    e:\tau_2 \toctx, x:\sigma_1, \ctxr }{\tpreinf \blam x {\tau_1} e : (\bpi x {\sigma_1}
    [\ctxr]\sigma_2) \toctx, UV(\ctxr) }\rname{T-LamAnn}}
...
}{\tpreinf e_1~e_2:\sigma_2 \toctx}\rname{T-App}}

\newcommand*{\TAppPi}{\inferrule{
    \tpreinf e_1 : \bpi x {\tau_1} \tau_2 \toctx_1 \\
    \ctxl_1 \bychk e_2 : \tau_3 \toctx_2 \\
    \ctxl_2 \byuni [\ctxl_2]\tau_1 \uni [\ctxl_2]\tau_3 \toctx
  }{\tpreinf e_1~e_2:\tau_2 \subst x
    {e_2} \toctx}\rname{T-AppPi}}
\newcommand*{\TAppVar}{\inferrule{
    \tpreinf e_1 : \genA \toctx_1[\genA] \\
    \ctxl_1[\genA_1, \genA_2, \genA = \bpi x {\genA_1} {\genA_2}] \byinf e_2 : \sigma
    \toctx_2 \\
    \ctxl_2 \bysub  [\ctxl_2]\sigma \lt [\ctxl_2]\genA_1 \toctx
...
\tctx,x \bychk \sigma : \star \toctx, x, \ctxr}
{\tpreinf \forall x: \star. \sigma : \star \toctx }\rname{T-Poly}}
...
\newcommand*{\UAEq}{\inferrule{ }{\tpreuni \tau \uni \tau \toctxo}\rname{U-AEq}}
...
\newcommand*{\APi}{\inferrule{\tprechk e:\sigma_3 \toctx_1 \trto t
    \\ \ctxl_1 \bysub [\ctxl_1]\sigma_3 \lt [\ctxl_1]\sigma_1 \toctx
  }
  {\tpreapp (\bpi x {\sigma_1} \sigma_2)~e : \sigma_2[x \mapsto e] \toctx \trto
    t}
  \rname{A-Pi}}
\newcommand*{\AEVar}{
  \inferrule{\tprechk[{[\genA_2,\genA_1,\genA=\bpi x
      {\genA_1} \genA_2]}] e : \sigma \toctx_1 \trto t
    \\ \ctxl_1 \bysub [\ctxl_1]\sigma \lt [\ctxl_1]\genA_1 \toctx
  }{\tpreapp[{[\genA]}]
...
\newcommand*{\DSPolyR}{\inferrule{\tpresub[, x:\star] \sigma_1 \dsub \sigma_2 }{\tpresub \sigma_1 \dsub \forall x:\star. \sigma_2}\rname{DS-PolyR}}
\newcommand*{\DSPolyL}{\inferrule{\tprechk \tau:\star \\ \tpresub \sigma_1 \subst x \tau \dsub \sigma_2}{\tpresub \forall x:\star. \sigma_1 \dsub \sigma_2}\rname{DS-PolyL}}
\newcommand*{\DSPi}{\inferrule{\tpresub \sigma_3 \dsub \sigma_1 \\ \tpresub[,x:\sigma_1] \sigma_2 \dsub \sigma_4}{\tpresub \bpi x {\sigma_1} {\sigma_2} \dsub \bpi x {\sigma_3} {\sigma_4}}\rname{DS-Pi}}
\newcommand*{\DSAEq}{\inferrule{ }{\tpresub \sigma \dsub \sigma}\rname{DS-AEq}}

\newcommand*{\SPolyR}{\inferrule{\tpresub[, x:\star] \sigma_1 \lt \sigma_2 \toctx, x:\star, \ctxr }{\tpresub \sigma_1 \lt \forall x:\star. \sigma_2 \toctx}\rname{S-PolyR}}
\newcommand*{\SPolyL}{\inferrule{\tpresub[, \genA] \sigma_1 \subst x \genA \lt \sigma_2 \toctx}{\tpresub \forall x:\star. \sigma_1 \lt \sigma_2 \toctx}\rname{S-PolyL}}
...
\newcommand*{\SEVarR}{\inferrule{\tctx \byrf^+ \sigma \rfto \tau \toctx_1 \\ \ctxl_1 \byuni \tau \uni \genA \toctx}{\tpresub[{[\genA]}] \sigma \lt \genA \toctx}\rname{S-EVarR}}
...
\newcommand*{\IApp}{\inferrule{\tctx \bycg e_1 \cgto e'_1 \toctx_1 \\
    \ctxl_1 \bycg e_2 \cgto e'_2 \toctx
  }{
    \tctx \bycg e_1 ~ e_2 \cgto e'_1 ~ e'_2 \toctx
  }
  \rname{I-App}}
\newcommand*{\ILam}{\inferrule{
    \tctx \bycg \sigma \cgto \sigma_1' \toctx_1 \\
    \ctxl_1, x:\sigma \bycg e \cgto e' \toctx, x: \sigma
  }{
    \tctx \bycg \blam x \sigma e \cgto \blam x {\sigma'} {e'} \toctx
  }
  \rname{I-Lam}}
\newcommand*{\IPi}{\inferrule{\tctx \bycg \sigma_1 \cgto \sigma'_1 \toctx_1 \\
    \ctxl_1, x: \sigma_1 \bycg \sigma_2 \cgto \sigma'_2 \toctx, x: \sigma_1
  }{
    \tctx \bycg \bpi x {\sigma_1} ~ {\sigma_2} \cgto \bpi x {\sigma'_1} {\sigma'_2} \toctx_2
  }
  \rname{I-Pi}}

\newcommand*{\IPiA}{\inferrule{\tctx \byrf^{-s} \sigma_1 \rfto \tau_1 \toctx_1 \\ \ctxl_1 \byrf^s [\ctxl_1]\sigma_2 \rfto \tau_2 \toctx }
{\tctx \byrf^s \bpi x {\sigma_1} {\sigma_2} \rfto \bpi x {\tau_1} {\tau_2} \toctx}\rname{I-Pi}}
\newcommand*{\IPoly}{\inferrule{\tctx[\genA_1, \genA] \byrf^+ \sigma \subst x {\genA_1} \rfto \tau \toctx}{\tctx[\genA] \byrf^+ \forall x:\star. \sigma \rfto \tau \toctx}\rname{I-Poly}}
...
\newcommand*{\TWCTypedVar}{\inferrule{\tctx \wc\\ x \notin dom(\tctx) \\
    \tctx \bywf \sigma}{\tctx, x: \sigma \wc}\rname{WC-Var}}
...
\newcommand*{\TWTLam}{\inferrule{\tprewt[,x:\sigma] e}{\tprewt \blam x \sigma e}\rname{WT-Lam}}
...
\newcommand*{\TWTPoly}{\inferrule{\tprewt[,x:\star] \sigma }{\tprewt \forall x:\star. \sigma}\rname{WT-Poly}}
...
\newcommand*{\CETypedVar}{\inferrule{\tctx \exto \ctxr \\ [\ctxr]\sigma_1 = [\ctxr]\sigma_2}{\tctx, x:\sigma_1 \exto \ctxr, x:\sigma_2}\rname{CE-TypedVar}}
...
\newcommand*{\ExUni}{\inferrule{
                               ...
                               {\tctx,\genA,\genB \byuni \genA \uni \bpi x \genB x \toctxo, \genA_1, \genA=\bpi x {\genA_1} x, \genB=\genA_1} \rname{U-EvarTy}}
